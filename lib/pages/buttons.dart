        ...
        builder: (context) => ListView(
            ...
            children: [
              ...
              MaterialButton(
                ...
                onPressed: () =>
                    _showSnackBar(context, typeName(MaterialButton)),
              ),
              ...
              OutlineButton(
                ...
                onPressed: () =>
                    _showSnackBar(context, typeName(OutlineButton)),
              ),
              ...
              ButtonBar(
                ...
                children: [
                  BackButton(
                    onPressed: () =>
                        _showSnackBar(context, typeName(BackButton)),
                  ),
                  CloseButton(
                    onPressed: () =>
                  ...
                  IconButton(
                    ...
                    onPressed: () =>
                        _showSnackBar(context, typeName(IconButton)),
                  ),
